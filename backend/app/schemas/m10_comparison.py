...
class M10ComparisonResponse(BaseModel):
    ...
    comparison_contract_version: Literal["m10-scenario-comparison-v2"]
    pair_admission_contract: Literal["m10-pair-admission-v2"]
    comparison_result_schema: Literal["m10-comparison-result-v2"]
    comparison_fingerprint_schema: Literal["m10-comparison-fingerprint-v2"]
