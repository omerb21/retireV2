...
SUCCESS_CASES = [
    ...
    },
    {
        ...
        "expected_numeric": {
            "grant_impact_total": 123426.15,
            "total_impact": 123426.15,
            "remaining_exempt_capital": 902573.85,
            "monthly_exempt_pension": 5014.3,
        },
        "expected_audit": [
            (1, "input_validation"),
            (2, "initial_entitlement"),
    ...
    },
    {
        ...
        "expected_numeric": {
            "grant_impact_total": 216000.0,
            "total_impact": 216000.0,
            "remaining_exempt_capital": 810000.0,
            "monthly_exempt_pension": 4500.0,
        },
        "expected_audit": [
            (1, "input_validation"),
            (2, "initial_entitlement"),
    ...
    },
    {
        ...
        "expected_numeric": {
            ...
            "actual_capitalization_impact": 60000.0,
            "idf_impact": 0.0,
            "total_impact": 262500.0,
            "remaining_exempt_capital": 763500.0,
            "monthly_exempt_pension": 4241.67,
        },
        "expected_audit": [
            (1, "input_validation"),
            (2, "initial_entitlement"),
