...
export interface M06Eligibility { subject_id: string; eligible_for_downstream: boolean; current_revision_id: string | null; exclusion_reasons: string[]; informational_warnings: string[]; meaning: string }
